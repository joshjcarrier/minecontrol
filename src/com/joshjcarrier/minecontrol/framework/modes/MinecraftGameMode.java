...
{
    public static String getKeyText(int keyEventId) {
        switch(keyEventId)
        {
            case KeyEvent.VK_1:
                return "Item 1";
    ...
    public static String getMouseButtonText(int mouseEventId) {
        switch(mouseEventId)
        {
    ...
    public static String getMouseScrollText(int scrollAmount) {
        if (scrollAmount > 0)
        {
            return "Next item";
        }
